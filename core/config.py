...
NEWS_CHANNELS = [
    ...
    {"name": "Al Jazeera English", "type": "channel", "region": "Global",
     ...
     "embed": "youtube", "active": True, "priority": 92},
    ...
    {"name": "India Today", "type": "channel", "region": "India",
     ...
     "embed": "youtube", "active": True, "priority": 86},
    ...
    {"name": "Sky News", "type": "channel", "region": "UK",
     ...
     "embed": "link", "active": True, "priority": 76,
     "note": "Sky News restricts live-stream embedding — watch on the official site or YouTube."},
